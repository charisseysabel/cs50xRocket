...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="js/table.expense.js"></script>
		...
		<title>CS50x: rocket | Expense</title>
                    ...
                    <div class="mid">
                        <h1>Expense</h1>
                            <div class="content">
			                    ...
			                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="expense" width="100%">
				                    <thead>
					                    <tr>
						                    <th>Transaction</th>
						                    <th>Category</th>
...
// radar chart for expenses tab
    $.getJSON("../exp_json_chart.php", function(data) {
        ...
        for(i = 0; i < data.length; i++) {
            exp_Rlabel.push(data[i].exp_category);
            exp_Rvalue.push(Number(data[i].exp_amount));
        }
